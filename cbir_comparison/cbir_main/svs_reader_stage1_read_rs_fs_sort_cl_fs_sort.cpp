   ...
   // openslide_t *osr = NULL;
        ...
        //start read and write
    {
        ...
        for(i=start_tile; i <= end_tile; i++ )
        {
            ...
            //CUT 30% of patch distance vector
            double XPERCENT = 0.3;
            ...
            long num_elements_x_percent = patch_distance_vector.size() * XPERCENT;
            ...
            for(long c = 0; c < num_elements_x_percent; c++)
            {
                ...
                result_distance_t temp = patch_distance_vector[c];
            ...
            tileCBIR_fineS_omp(patch_distance_vector,
